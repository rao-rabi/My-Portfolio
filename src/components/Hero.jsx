...
const Hero = () => {
  return (
    <section className="w-full h-screen relative mx-auto">
      <div
        className={`${styles.paddingX} inset-0 absolute top-[90px] max-w-7xl mx-auto flex flex-row items-start gap-5`}
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} text-white-100 mt-2`}>
            I develop User Interactive and responsive websites
          </p>
        </div>
      </div>
      <ComputersCanvas/>
